...
var $0a6d9e39e3bf8e28$exports = {};

$parcel$export($0a6d9e39e3bf8e28$exports, "VanillaGrid", () => $0a6d9e39e3bf8e28$export$a0fa6baaee363926);
...
class $0a6d9e39e3bf8e28$export$a0fa6baaee363926 {
    get itemsPerPage() {
    ...
    drawWrapper() {
        ...
        li = (0, $9d8a7340e3a1da8e$export$8fa3b0623dc5004a)('&laquo;', 'first', this.config.classNames);
        ul.append(li);
        li = (0, $9d8a7340e3a1da8e$export$8fa3b0623dc5004a)('&lsaquo;', 'prev', this.config.classNames);
        ul.append(li);
        ...
        li = (0, $9d8a7340e3a1da8e$export$8fa3b0623dc5004a)('&rsaquo;', 'next', this.config.classNames);
        ul.append(li);
        li = (0, $9d8a7340e3a1da8e$export$8fa3b0623dc5004a)('&raquo;', 'last', this.config.classNames);
        ul.append(li);
        const nav = (0, $04aafea2ee4a96c8$export$b11b83b4c0e60f43)('nav', '', this.config?.classNames?.nav);
        nav.append(ul);
        const wrapper = (0, $04aafea2ee4a96c8$export$b11b83b4c0e60f43)('div', '', `vg-wrapper ${this.config?.classNames?.wrapper || ''}`);
        if (this.infoText) {
            const info = (0, $04aafea2ee4a96c8$export$b11b83b4c0e60f43)('div', '', 'info');
            wrapper.append(info);
        }
        wrapper.append(nav);
    ...
    renderBtns() {
        ...
        btns.forEach((btn)=>{
            ...
            if (btn.classList.contains('number') && parseInt(btn.innerText) == parseInt(this.currentPage)) (0, $a318dd636e8fabe8$export$989e9142cd3eb435)(btn, this.activeClass);
        });
        if (this.currentPage == 1) {
            const firstBtn = this.wrapper.querySelector("button.page.first");
            const prevBtn = this.wrapper.querySelector("button.page.prev");
            (0, $a318dd636e8fabe8$export$989e9142cd3eb435)(firstBtn, this.activeClass);
            (0, $a318dd636e8fabe8$export$989e9142cd3eb435)(prevBtn, this.activeClass);
        }
        if (this.currentPage == this.totalPages) {
            ...
            (0, $a318dd636e8fabe8$export$989e9142cd3eb435)(lastBtn, this.activeClass);
            (0, $a318dd636e8fabe8$export$989e9142cd3eb435)(nextBtn, this.activeClass);
        }
    }
}


var $f8bddfb2ef71d75e$exports = {};

$parcel$export($f8bddfb2ef71d75e$exports, "VanillaServerGrid", () => $f8bddfb2ef71d75e$export$2adb53ea8106b8c1);



class $f8bddfb2ef71d75e$export$2adb53ea8106b8c1 extends EventTarget {
    get itemsPerPage() {
        return this.config?.itemsPerPage || 10;
    }
    get totalPages() {
...
$parcel$exportWildcard(module.exports, $0a6d9e39e3bf8e28$exports);
$parcel$exportWildcard(module.exports, $f8bddfb2ef71d75e$exports);
